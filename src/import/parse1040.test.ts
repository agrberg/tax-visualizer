...
describe('parse1040', () => {
  it('extracts text items from the file and maps them onto ParsedReturn fields', async () => {
    extractTextItems.mockResolvedValueOnce([
      { text: '1z', originalText: '1z', x: 40, y: 600, width: 10, page: 1 },
      { text: 'add lines 1a through 1h', originalText: 'Add lines 1a through 1h', x: 70, y: 600, width: 100, page: 1 },
      { text: '118,000', originalText: '118,000', x: 520, y: 600, width: 40, page: 1 },
    ]);
