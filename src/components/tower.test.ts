...
import { AXIS_HEADROOM, axisMaxFor, marginalOrdinaryIdx, ordinaryAxisMaxFor, nextOrdinaryBracket, tall } from './tower';
...
describe('axisMaxFor', () => {
  ...
  it('lands the two towers at the same fill height', () => {
    ...
    const capFill = (fed.preferentialDeduction + fed.capitalGainsBaseline + fed.preferentialTaxable) / axisMaxFor(r);
